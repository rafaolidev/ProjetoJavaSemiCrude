...
public class AppScreen extends JFrame {
	...
	JButton addContato = new JButton( Constantes.ADICIONAR_CONTATO ) ;
	JButton altContato = new JButton( Constantes.ALTERAR_CONTATO );
	JButton delContato = new JButton( Constantes.REMOVER_CONTATO );
